...
\begin{figure}[H]
\centering{}
\includegraphics[]{img/analysis.png}
...
\begin{enumerate}
    ...
    \end{itemize}
\end{enumerate}
Un'eccezione si ha durante i primi 2 turni di ogni giocatore: in questo caso, infatti, ogni giocatore può costruire (gratuitamente) 1 colonia e 1 strada.\\
