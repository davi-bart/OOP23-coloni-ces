...
public final class Utility {
    ...
    static Map<RoadDirection, Pair<Pair<Double, Double>, Pair<Double, Double>>> getRoadCoordinates(final double radius,
        ...
        roads.put(RoadDirection.UPLEFT, new Pair<>(hexagonCoordinates.get(0), hexagonCoordinates.get(1)));
        roads.put(RoadDirection.LEFT, new Pair<>(hexagonCoordinates.get(1), hexagonCoordinates.get(2)));
        roads.put(RoadDirection.DOWNLEFT, new Pair<>(hexagonCoordinates.get(2), hexagonCoordinates.get(3)));
        roads.put(RoadDirection.DOWNRIGHT, new Pair<>(hexagonCoordinates.get(3), hexagonCoordinates.get(4)));
        roads.put(RoadDirection.RIGHT, new Pair<>(hexagonCoordinates.get(4), hexagonCoordinates.get(5)));
        roads.put(RoadDirection.UPRIGHT, new Pair<>(hexagonCoordinates.get(5), hexagonCoordinates.get(0)));
